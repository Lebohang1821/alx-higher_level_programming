...
class Rectangle(Base):
    ...
    def __init__(self, width, height, x=0, y=0, id=None):
        ...
        Args:
            ...
            id (int): dentity of new Rectangle.
        Raises:
    ...
    @property
    def x(self):
        """It set x coordinate of Rectangle."""
        return self.__x
    ...
    @property
    def y(self):
        """It set y coordinate of Rectangle."""
        return self.__y
    ...
    def display(self):
        """It prints Rectangle using `#` character."""
    ...
    def to_dictionary(self):
        """It return dictionary representation of Rectangle"""
        return {
            "id": self.id,
            "width": self.width,
            "height": self.height,
    ...
    def __str__(self):
        """It return print() and str() representation of Rectangle"""
