#!/usr/bin/python3
"""Uni-tests for models/square.py.
...
class TestSquare_instantiation(unittest.TestCase):
    """Uni-tests for testing instantiation of Square class."""
...
class TestSquare_size(unittest.TestCase):
    """Uni-tests for testing size initialization of Square class."""
...
class TestSquare_x(unittest.TestCase):
    """Uni-tests for initializing Square x attribute."""
...
class TestSquare_y(unittest.TestCase):
    """Uni-tests for initializing of Square y attribute."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Uni-tests for ordering of Square attribute initialization."""
...
class TestSquare_area(unittest.TestCase):
    """Uni-tests for area method of Square class."""
...
class TestSquare_stdout(unittest.TestCase):
    """Uni-tests for __str__ and display methods of Square class."""

    @staticmethod
    def capture_stdout(sq, method):
        """It return and captures texts printed - stdout.

        Args:
            sq (Square): Quare of print - stdout.
            method (str): Method - run on sq.
        Returns:
...
class TestSquare_update_args(unittest.TestCase):
    """Uni-tests for updating args method of Square class."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Uni-tests for updating kwargs method of Square class."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Uni-tests for to_dictionary method of squar class."""
